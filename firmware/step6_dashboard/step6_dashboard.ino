/*
 * Phantom Load Killer — Step 6: WiFi Dashboard
 * =============================================================
 * Adds over Step 5:
 *   - ESP32 Access Point (AP) WiFi — no router needed
 *   - Full web dashboard with live readings at http://192.168.4.1
 *   - Manual relay ON/OFF control from dashboard
 *   - Auto-mode toggle (enable/disable idle detection)
 *
 * WiFi:
 *   SSID     : PhantomKiller
 *   Password : phantom123
 ...
 *
 * All wiring unchanged from Step 5:
